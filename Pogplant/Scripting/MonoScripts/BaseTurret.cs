                ...
                if (isFiring)
                {
                    ...
                    if (can_fire)
                    {
                        ...
                        if (fire_timer >= fireRate)
                        {
                            ...
                            GameUtilities.FireEnemyBullet(turret_muzzle, ECS.GetGlobalPosition(turret_muzzle) + Transform.GetForwardVector(turret_muzzle), Transform.GetForwardVector(turret_muzzle), 5.0f, 5.0f);
