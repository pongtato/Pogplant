...
namespace Pogplant
{
	struct DebugDraw
	{
		...
		static void DebugLineConst(glm::vec3 _Position1, glm::vec3 _Position2);
		...
		static void DebugSphereMono(float pos_x, float pos_y, float pos_z, float camdir_x, float camdir_y, float camdir_z, float _Radius, size_t _Segments = 36);
		...
		static std::vector<glm::vec3> m_DebugVertsConst;
