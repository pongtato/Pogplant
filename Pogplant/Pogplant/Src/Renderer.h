...
namespace Pogplant
{
	...
	public:
		...
		static void DebugPass(const char* _CameraID, const entt::registry& registry);
		...
		static void Draw(const char* _CameraID, const entt::registry& registry, Components::Renderer* _Selected, bool _EditorMode);
		static void DrawDebug(const char* _CameraID, const entt::registry& registry, Components::Renderer* _Selected);
