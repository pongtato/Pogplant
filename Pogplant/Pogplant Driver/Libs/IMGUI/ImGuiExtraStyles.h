...
namespace imgui_extra_styles
{
	...
	inline void Eggplant()
	{
		...
		style->Colors[ImGuiCol_TabHovered] = ImVec4(0.25f, 0.19f, 0.22f, 1.00f);
		style->Colors[ImGuiCol_TabActive] = ImVec4(0.20f, 0.14f, 0.17f, 1.00f);
