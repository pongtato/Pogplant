...
namespace Scripting
{
	...
	public:
		...
		static glm::vec3 GetRayCastDirCamera(std::uint32_t playerCamera, glm::vec3 screenCoordinates);
		...
		static void InvokeScriptFunction(std::uint32_t entity_id, MonoString* script_name, MonoString* script_function);
		...
		static void UpdateText(std::uint32_t text_object, MonoString* _str);
